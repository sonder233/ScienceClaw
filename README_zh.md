...
RpaClaw 是一款隐私优先的个人助手，具备 RPA（流程自动化）能力，基于 [LangChain DeepAgents](https://github.com/langchain-ai/deepagents) 架构与 [AIO Sandbox](https://github.com/agent-infra/sandbox) 基础设施构建。提供 1,900+ 内置工具、多格式文档生成、沙箱代码执行和浏览器自动化录制功能。

<div align="center">

*RPA 录制与回放 · 1,900+ 内置工具 · 多格式生成 · 完全本地化 · 隐私优先*
...
[产品优势](#why-rpaclaw) · [架构](#architecture) · [动态](#news) · [快速开始](#quick-start) · [本地配置](#local-setup) · [免费额度](#free-api-credits) · [工具与技能](#tools-skills) · [实用功能](#practical-features) · [项目结构](#project-structure) · [常用命令](#commands) · [社区](#community) · [致谢](#acknowledgements)
...
无需繁琐配置。使用预构建 Docker 镜像**一条命令**即可启动。内置 1,900+ 工具和技能包。无论您是自动化工作流还是构建 AI Agent，都能立即上手。
...
- **[2026-03-13]** RpaClaw v0.0.1 正式发布！欢迎访问我们的官网：[rpaclaw.taichuai.cn](https://rpaclaw.taichuai.cn/)
...
| 📨 **飞书集成** | 在设置中配置 Webhook 通知——任务结果和告警直接推送到飞书群聊。 |
...
- 通过 [GitHub Issues](https://github.com/AgentTeam-TaichuAI/RpaClaw/issues) 提交问题和功能建议
- 与社区分享您的自定义工具和技能
